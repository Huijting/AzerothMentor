...
-- Optional dev toggles (see `/am debug milestones`, `/am debug cards`, `/am debug lessonlog`, `/am debug cooldowns`; `/am cooldowns`, `/am localcds`, `/am talents` for one-shot reports).
